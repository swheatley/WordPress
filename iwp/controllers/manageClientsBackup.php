	...
	public static function triggerRecheckResponseProcessor($historyID, $responseData){
		...
		if(!empty($responseData))
		{
			...
			else
			{
				...
				DB::update("?:history_additional_data", array('status' => 'error', 'errorMsg' => isset($responseData['success']['error']) ? strip_tags($responseData['success']['error']) : $errorMsg, 'error' => isset($responseData['success']['error_code']) ? $responseData['success']['error_code'] : $errorCode), $where);
