...
function setMultiCallOptions(&$requestParams)
{
	...
	{
		$requestParams['args']['zip_split_size'] = 512;	//MB
	}
	else
	{
	...
	{
		$requestParams['args']['file_loop_break_time'] = 18;
		$requestParams['args']['db_loop_break_time'] = 18;
		if(!empty($requestParams['secure']['account_info']))
		{
			$requestParams['secure']['account_info']['upload_loop_break_time'] = 18;
		}
	}
	else
	{
